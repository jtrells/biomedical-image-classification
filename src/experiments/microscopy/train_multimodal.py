...
def main():
    ...
    parser.add_argument('--text-model-path', type=str, default='/workspace/src/experiments/microscopy/outputs/graceful-moon-64/final.pt')
