...
class TrainerWrapper():
    ...
    def run(self):
        ...
        train_transform, val_transform, test_transform = self._get_train_val_transformations(
            mean, std)
...
if __name__ == '__main__':
    args = read_arguments()
    run = TrainerWrapper(args.dataset_filepath,
                         args.images_path,
                         args.output_dir,
                         args.taxonomy,
