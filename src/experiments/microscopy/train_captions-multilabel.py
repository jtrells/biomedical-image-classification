...
def main():
    ...
    DATA_PATH = BASE_PATH / 'multilabel-captions.csv' #multimodality_classification.csv'
    ...
    filters = [128, 256]
    lrs = [1e-4]
    max_words_sentence = [100, 250, 500]
    tags = ['script', 'captions', 'glove', 'baseline', 'multi-label']   
